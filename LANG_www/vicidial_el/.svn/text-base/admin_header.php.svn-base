...
<B><FONT FACE="ARIAL,HELVETICA" COLOR=white>ADMINISTRATION</FONT></B><BR>
	...
	if ($SSoutbound_autodial_active > 0)
		...
		if (strlen($lists_hh) > 1) { 
			if ($LOGdelete_from_dnc > 0) {$DNClink = 'Προσθήκη-Διαγραφή Αριθμός Από DNC';}
		...
		<a href="./new_listloader_superL.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> Νέοι μόλυβδοι φορτίων </a>
		</TD></TR>
		<?php } 
		}
	?>
	...
	<a href="<?php echo $ADMIN ?>?ADD=1000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?php echo $ingroups_fc ?> SIZE=<?php echo $header_font_size ?>><?php echo $ingroups_bold ?> $$$-ΟΜΑΔΕΣ </a>
	</TD></TR>
	<?php
	if (strlen($ingroups_hh) > 1) 
		...
		<a href="<?php echo $ADMIN ?>?ADD=1211"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> $$$-ΟΜΑΔΑ αντιγράφων </a><HR>
		</TD></TR><TR BGCOLOR=<?php echo $ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		...
		<a href="<?php echo $ADMIN ?>?ADD=1411"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?php echo $subheader_font_size ?>> ΑντιγραφήDID </a><HR>
		</TD></TR><TR BGCOLOR=<?php echo $ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
