...
if ($ACTION == 'CALLLOGview')
	...
	if ($g > 0)
		...
		{echo "<tr bgcolor=white><td colspan=11 align=center>No calls στο this day</td></tr>";}
...
if ($ACTION == 'LEADINFOview')
	...
	if (strlen($lead_id) < 1)
		...
		if ($info_to_print > 0) 
			{
			$row=mysql_fetch_row($rslt);
			echo "<tr bgcolor=white><td ALIGN=right><font size=2>Κατάσταση: &nbsp; </td><td ALIGN=left><font size=2>$row[0]</td></tr>";
			...
			echo "<tr bgcolor=white><td ALIGN=right><font size=2>Αποκαλούμενος Since Επίθετο Reset: &nbsp; </td><td ALIGN=left><font size=2>$row[4]</td></tr>";
			...
			echo "<tr bgcolor=white><td ALIGN=right><font size=2>Αποκαλούμενος Count: &nbsp; </td><td ALIGN=left><font size=2>$row[24]</td></tr>";
			echo "<tr bgcolor=white><td ALIGN=right><font size=2>Επίθετο Local Call Time: &nbsp; </td><td ALIGN=left><font size=2>$row[25]</td></tr>";
