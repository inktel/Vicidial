...
if ($did > 0)
	...
	{echo "<B> &nbsp; Statistiche utente for $user";}
...
if ($did > 0)
	...
	echo " | <a href=\"./admin.php?ADD=3311&did_id=$did_id\">ModificareDID</a>\n";
	}
else
	{
