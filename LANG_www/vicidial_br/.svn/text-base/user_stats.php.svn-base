...
<title>ADMINISTRATION: Estatísticas de Usuário
<?php
...
?>
<TABLE WIDTH=770 BGCOLOR=#E6E6E6 cellpadding=2 cellspacing=0><TR BGCOLOR=#E6E6E6><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; Estatísticas de Usuário for <?php echo $user ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2> &nbsp; </TD></TR>
...
echo " | <a href=\"./AST_agent_days_detail.php?user=$user&query_date=$begin_date&end_date=$end_date&group[]=--ALL--&shift=ALL\">Usuário multiple day status detail report</a>";
echo "</center>\n";
...
echo "<B>AGENTE TEMPO E STATUS DA CHAMADA:</B>\n";
...
echo "<tr><td><font size=2>TOTAL DE CHAMADAS </td><td align=right><font size=2> $total_calls</td><td align=right><font size=2> $call_hours_minutes</td></tr>\n";
echo "</TABLE></center>\n";
...
echo "<B>SAINTE CALLS FOR THIS TIME PERIOD: (10000 record limit)</B>\n";
echo "<TABLE width=670 cellspacing=0 cellpadding=1>\n";
...
echo "<B>ENTRANTE/CLOSER CALLS FOR THIS TIME PERIOD: (10000 record limit)</B>\n";
...
echo "<B>MANUAL SAINTE CALLS FOR THIS TIME PERIOD: (10000 record limit)</B>\n";
echo "<TABLE width=750 cellspacing=0 cellpadding=1>\n";
