#!/usr/bin/perl
#
# AST_DB_did_route_internal_NSD.pl version 2.0.5   *DBI-version*
#
# DESCRIPTION:
# 
# - Sets did_route to keep calls within system for NSD
#
# CHANGES
...
$stmtA = "UPDATE vicidial_inbound_dids set did_route=filter_url where did_id >= 259 and did_id <= 341;";
	if($DB){print STDERR "\n|$stmtA|\n";}
	if (!$T) {
